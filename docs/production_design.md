...
### 핵심 기능
- [x] 퍼즐 전투 시스템 (6x6 그리드, sword/shield/potion/coin/mana)
- [x] 던전 생성 알고리즘 (층별 적 스폰, 5층마다 상점)
- [x] 아이템/스킬 시스템 (상점 아이템, Fireball/Stun 스킬)
- [x] 영구 죽음 (Permadeath - 죽으면 Soul Stones 획득 후 리셋)
- [x] 메타 진행 (HP/Attack/Gold 영구 업그레이드)
...
- [ ] 30+ 스킬 (현재 2종)
- [ ] 5+ 캐릭터 (현재 1종)
- [x] 5종 적 타입 (Goblin, Orc, Bat, Shaman, Dragon)
- [x] 보스 (Dragon - 10층마다)

### 메타 시스템
- [x] 영혼석 시스템 (Soul Stones)
- [x] 메타 업그레이드 (3종: HP, Attack, Gold)
- [ ] 캐릭터 해금
- [ ] 도전과제
- [ ] 일일 도전

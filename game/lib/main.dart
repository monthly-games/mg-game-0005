...
class MyApp extends StatelessWidget {
  ...
  static const gameId = 'MG-0005';
  static const gameTitle = 'Roguelike Puzzle Dungeon';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            MGAdaptiveText('MG-0005 STABILIZED', style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold)),
